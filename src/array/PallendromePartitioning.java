...
public class PallendromePartitioning {
	public PallendromePartitioning(char[] input, int l) {
	...
	public static void main(String[] args) {
		...
		PallendromePartitioning p = new PallendromePartitioning(input.toCharArray(), input.length());
	}
}
